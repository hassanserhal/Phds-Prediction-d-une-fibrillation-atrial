...
for i in range(len(listderv1)) :
        ...
        imfs_globale_derv1.append([i,imfs_normale,imfs_anormale])
"""        
imfs_globale_derv1=[]
for i in range(len(listderv1)) :
        signal_normal=listderv1[i][0]
...
if (p0>50 or p1>50 or p2>50 or p3>50 or p4>50 or p5>50 or p6>50 or p7>50 or p8>50 or p9>50 or p10>50 or p11>50):
