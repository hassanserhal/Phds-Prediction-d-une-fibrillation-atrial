...
for i in range(len(imfs_globale_derv0)):
    ...
    imfs_retenue=[]
    l_temp_variance,l_temp_standard_deviation,l_temp_mean,l_temp_coeffiecient_variation,l_temp_percentage = [],[],[],[],[]
...
for i in range(len(imfs_globale_derv0)):
       ...
       list_imfs_anormaux=signal[1]
       imfs_retenue=[]
       l_temp_variance,l_temp_standard_deviation,l_temp_mean,l_temp_coeffiecient_variation,l_temp_ecart,l_temp_percentage= [],[],[],[],[],[]
...
imfs_final=[]
if (p0>50):
    imfs_final.append([imf_normal[0],imf_anormal[0]])
if (p1>50):
    imfs_retenue.append([imf_normal[1],imf_anormal[1]])    
if (p2>50):
    imfs_retenue.append([imf_normal[2],imf_anormal[2]])        
if (p3>50):
    imfs_retenue.append([imf_normal[3],imf_anormal[3]])
if (p4>50):
    imfs_retenue.append([imf_normal[4],imf_anormal[4]])
if (p5>50):
    imfs_retenue.append([imf_normal[5],imf_anormal[5]])
if (p6>50):
    imfs_retenue.append([imf_normal[6],imf_anormal[6]])
if (p7>50):
    imfs_retenue.append([imf_normal[7],imf_anormal[7]])
if (p8>50):
    imfs_retenue.append([imf_normal[8],imf_anormal[8]])
if (p9>50):
    imfs_retenue.append([imf_normal[9],imf_anormal[9]])
if (p10>50):
    imfs_retenue.append([imf_normal[10],imf_anormal[10]])
if (p11>50):
    imfs_retenue.append([imf_normal[11],imf_anormal[11 ]])
