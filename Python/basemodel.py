...
if database_name == 'PAF':         
    list_test=[]                #all signal
    list_normale=[]             #even signal
    list_anormale=[]            #odd signal
    listderv0=[]
    listderv1=[]
    count=0
...
sklearn.metrics.confusion_matrix(y, y_train, labels=None, sample_weight=None, normalize=None)
