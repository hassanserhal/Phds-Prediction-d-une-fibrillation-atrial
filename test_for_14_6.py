...
def significativity (coeffiecient_correlation):
    for i in coeffiecient_correlation :
        if i > 0.15 :
            return True
    return False
#def read image
...
# EMD p01c-p02c
    ...
    for i in range(len(imfs_globale_derv0)):
       ...
       for j in range(min(len(list_imfs_normaux),len(list_imfs_anormaux))):
           ...
           coeffiecient_correlation= standard_deviation/mean
           list_coeffiecient_correlation.append(coeffiecient_correlation)
           significativit=significativity(coeffiecient_correlation)
       ...
       list_mean1=[]
       list_coeffiecient_correlation1=[]
    ...
    for i in range(len(imfs_globale_derv1)) :
       ...
       for j in range(min(len(list_imfs_normaux1),len(list_imfs_anormaux1))):
           ...
           standard_deviation1=np.var(array_imf1,axis=0)
           list_standard_deviation1.append(standard_deviation1)
           mean1=np.var(array_imf1,axis=0)
           list_mean1.append(mean1)
           coeffiecient_correlation1=np.var(array_imf1,axis=0)
           list_coeffiecient_correlation1.append(coeffiecient_correlation1)
           significativit1=significativity(coeffiecient_correlation1)
